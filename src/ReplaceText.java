...
public final class ReplaceText
{
	...
	public static void deleteData( String[] args ) throws IOException
    {
//        if()//args.length != 4 )
//        {
//            usage();
...
//                System.out.println(args[0] + " => "+ args[1]);
                ...
                document = _ReplaceText(document, args[1], args[2]);                
                ...
                if (next instanceof Operator) 
                {
                    ...
                    if (op.getName().equals("Tj")) 
                    {
                        ...
                        if(string.contains("(") || string.contains(")")) {
                            ...
                            string = string.replaceFirst(Pattern.quote(searchString), replacement);
                        }
